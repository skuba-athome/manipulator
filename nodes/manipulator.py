...
def init_point_split(data):
	global pub
	actionList['object_point'] = []
	actionList['object_point'].append('joint1,0/joint2,0.5/joint3,0/gripper,0.5')
	actionList['object_point'].append('mark43_1,1.02/mark43_2,1.02/mark43_3,0')
	actionList['object_point'].append('mark43_1,1.02/mark43_2,1.02/mark43_3,0')
	actionList['object_point'].append('mark43_1,1.02/mark43_2,1.02/mark43_3,0')
	actionList['object_point'].append('joint1,0/joint2,0/joint3,0/gripper,-1.4')
...
def init_point_split_top(data):
	global pub
	actionList['object_point'] = []
	actionList['object_point'].append('joint1,1.57/joint3,-1.57/gripper,0.5')
	actionList['object_point'].append('mark43_1,1.57/mark43_2,1.57/mark43_3,0/joint2,-1.57')
	actionList['object_point'].append('joint1,0/joint2,-1/joint3,-1.57/gripper,-1.4')
